 ...
 Формат данных подобен .c:
   [&lt;type>] [name] : &lt;значение>;
 где:

   &lt;type>
      - тип данных из списка возможных. Может отсутствовать для данных внутри объекта или массива.
        Примеры:
      CHAR
   ...
   name
      - название данных. Может отсутствовать для данных внутри объекта или массива.
        Это название после обработки попадёт в файл с аналогичным названием:
        <I2CMemory.h> и будет указывать на вычисленное смещение от начала памяти, например:
#define name 234
